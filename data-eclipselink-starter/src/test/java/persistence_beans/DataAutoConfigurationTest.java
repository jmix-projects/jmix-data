...
import io.jmix.autoconfigure.data.DataEclipselinkAutoConfiguration;
import io.jmix.core.Stores;
import io.jmix.dataeclipselink.impl.JmixEclipselinkTransactionManager;
...
public class DataAutoConfigurationTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(DataSourceAutoConfiguration.class, DataEclipselinkAutoConfiguration.class, CacheAutoConfiguration.class))
